...
const RightSidebar = () => {
  ...
  //Get all the images from the messagess and set them to state
  useEffect(()=>{
    setMsgImages(
      messages.filter(msg=>msg.image).map(msg=>msg.image) // first all image msg are seperated then their url's are stored
    )
  },[messages])
